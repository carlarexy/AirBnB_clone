...
class HBNBCommand(cmd.Cmd):
    ...
    intro = "Welcome to the AirBnB clone console! Type 'help' to list commands. \a"
    prompt = "(hbnb) "
    ...
    def help_quit(self):
        ...
        print("Quit command to exit the program\a")
        return
    ...
    def do_show(self, line):
        ...
        name and id. Ex: $ show BaseModel 6789-6789-6789."""
        args = line.split()
